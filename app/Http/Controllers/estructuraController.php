...
class EstructuraController extends Controller
{
    public function index()
    {
        ...
        if ($role === 'admin') {
            return view('admin.EstructuraOrg.index', compact('seccionesPrincipales', 'categoriaID'));
        } 
        elseif ($role === 'usuario') {
            return view('usuario.EstructuraOrg.index', compact('seccionesPrincipales', 'categoriaID'));
        } 
        else {
