...
class IndicadoresController extends Controller
{
    public function index()
    {
        ...
        if ($role === 'admin') {
            return view('admin.Indicadores.index', compact('seccionesPrincipales', 'categoriaID'));
        } 
        elseif ($role === 'usuario') {
            return view('usuario.Indicadores.index', compact('seccionesPrincipales', 'categoriaID'));
        } 
        else {
