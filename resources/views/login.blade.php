...
<head>
    ...
    <title>Iniciar Sesión - Normateca Institucional</title>
        ...
        <div class="text-center mb-4">
            <a href="/" class="inline-block">
                <div class="logo-container inline-block mb-2">
                    <img src="assets/img/logo_nuevo_2_Mesa de trabajo 1.png" alt="Cesun Universidad" class="h-20 mx-auto">
                </div>
            </a>
            <p class="text-white/80 text-xs">Normateca Institucional</p>
        </div>
